const fa = {
  ...
  products: {
    ...
    gifts: {
      title: "هدایای خرید",
      subtitle:
        "بعد از تحویل هر سفارش، یکی از این آیتم‌ها به‌صورت یکبارمصرف برای کاربر فرستاده می‌شود. اگر لیست خالی باشد چیزی فرستاده نمی‌شود.",
      new: "+ افزودن هدیه",
      content: "محتوای هدیه",
      contentPlaceholder: "اطلاعات اکانت هدیه (می‌تواند چند خط باشد)...",
      statusCol: "وضعیت",
      available: "آماده",
      used: "ارسال‌شده",
      delete: "حذف",
      deleteConfirm: "این آیتم هدیه حذف شود؟",
      empty: "هیچ آیتم هدیه‌ای وجود ندارد",
      template: {
        title: "قالب پیام هدیه",
        hint: "از {item} برای محتوای هدیه و {orderId} برای شماره سفارش استفاده کنید.",
        enabled: "ارسال هدیه فعال است",
        fa: "قالب فارسی",
        en: "قالب انگلیسی",
        ru: "قالب روسی",
        save: "ذخیره قالب",
